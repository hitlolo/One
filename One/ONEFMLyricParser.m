 ...
 *  sid
 */
static NSString* const lyric_url = @"http://api.douban.com/v2/fm/lyric";

@interface ONEFMLyricParser()
@property(nonatomic,strong)AFHTTPSessionManager* httpManager;
@end

@implementation ONEFMLyricParser
...
- (void)fetchLyric:(ONESong*)song completion:(void (^)())completionHandler{
    ...
    [_httpManager GET:lyric_url parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
